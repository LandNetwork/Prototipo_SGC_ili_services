...
# JAVA CONFIGURATION
##############################################################################
FULL_JAVA_EXE_PATH = 'java'
JAVA_REQUIRED_VERSION = 1.8

##############################################################################
# ILI2DB PARAMETERS CONFIGURATION
##############################################################################
...
##############################################################################
ILISERVICES_DB_NAME = "igac"#os.environ.get("ILISERVICES_DB_NAME")
ILISERVICES_DB_USER = "postgres"#os.environ.get("ILISERVICES_DB_USER")
ILISERVICES_DB_PASS = "123456"#os.environ.get("ILISERVICES_DB_PASS")
ILISERVICES_DB_PORT = "5432"#os.environ.get("ILISERVICES_DB_PORT")
ILISERVICES_DB_HOST = "localhost"#os.environ.get("ILISERVICES_DB_HOST")
