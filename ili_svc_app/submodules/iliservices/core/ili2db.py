...
from ..modelbaker.iliwrapper import (ilivalidator,
                                     iliimporter,
                                     iliexporter,
                                     iliupdater)
...
class Ili2DB(QObject):
    ...
    def validate(self, db, configuration: ValidateConfiguration):
        ...
        try:
            ...
            if (res_validation != ilivalidator.Validator.SUCCESS
                    and res_validation != ilivalidator.Validator.SUCCESS_WITH_VALIDATION_ERRORS):
